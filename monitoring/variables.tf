...
variable "metric_alerts" {
  description = "Map of metric alert definitions with static thresholds (auto-generated from matrix)"
  type = map(object({
    alert_name           = string
    resource_id          = string
...
variable "metric_alerts_dynamic" {
  description = "Map of metric alert definitions with dynamic thresholds (auto-generated from matrix)"
  type = map(object({
    alert_name                = string
    resource_id               = string
    metric_namespace          = string
    ...
    failing_periods_to_alert  = number
