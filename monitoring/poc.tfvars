...
resource_group_name          = "rg-monitoring-deployflow-poc"
log_analytics_workspace_name = "law-monitoring-deployflow-poc"
...
activity_log_alerts = {
  ...
  "aks-odoo-action-failure" = {
    ...
    resource_id    = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-deployflow-poc/providers/Microsoft.ContainerService/managedClusters/aks-odoo"
    operation_name = "Microsoft.ContainerService/managedClusters/start/action"
    category       = "Administrative"
    status         = "Failed"
    description    = "AKS cluster start failed - Failure"
  }
