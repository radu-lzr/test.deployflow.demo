...
resource_group_name          = "rg-monitoring-poc"
log_analytics_workspace_name = "law-monitoring-poc"
...
metric_alerts = {
  ...
  "la-monitor-poc-alerts-triggersfailed-1" = {
    alert_name           = "la-monitor-poc-alerts-TriggersFailed-1"
    resource_id          = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    ...
    evaluation_frequency = "PT5M"
    window_size          = "PT5M"
    description          = "Metric alert: TriggersFailed on la-monitor-poc-alerts"
  }
  "la-monitor-poc-alerts-runscancelled-1" = {
    alert_name           = "la-monitor-poc-alerts-RunsCancelled-1"
    resource_id          = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    metric_namespace     = "microsoft.logic/workflows"
    metric_name          = "RunsCancelled"
    operator             = "GreaterThanOrEqual"
    aggregation          = "Average"
    threshold            = 1
    severity             = 1
    evaluation_frequency = "PT5M"
    window_size          = "PT5M"
    description          = "Metric alert: RunsCancelled on la-monitor-poc-alerts"
  }
  "la-monitor-poc-alerts-runsfailed-1" = {
    alert_name           = "la-monitor-poc-alerts-RunsFailed-1"
    resource_id          = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    metric_namespace     = "microsoft.logic/workflows"
    ...
    evaluation_frequency = "PT5M"
    window_size          = "PT5M"
    description          = "Metric alert: RunsFailed on la-monitor-poc-alerts"
  }
}

metric_alerts_dynamic = {
}
...
activity_log_alerts = {
  "stdeployflowdemotest-action-success" = {
    ...
    status         = "Succeeded"
    description    = "Storage account key regenerated - Success"
    severity       = 3
  }
  ...
  "aks-odoo-write-success" = {
    ...
    category       = "Administrative"
    status         = "Succeeded"
    description    = "AKS node pool created or updated - Success"
    severity       = 3
  }
  "aks-odoo-write-failure" = {
    ...
    category       = "Administrative"
    status         = "Failed"
    description    = "AKS node pool created or updated - Failure"
    severity       = 3
  }
  ...
  "la-monitor-poc-alerts-action-success" = {
    alert_name     = "la-monitor-poc-alerts-action-Success"
    resource_id    = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    operation_name = "Microsoft.Logic/workflows/disable/action"
    category       = "Administrative"
    status         = "Succeeded"
    description    = "Logic App disabled - Success"
    severity       = 3
  }
  "la-monitor-poc-alerts-action-failure" = {
    alert_name     = "la-monitor-poc-alerts-action-Failure"
    resource_id    = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    operation_name = "Microsoft.Logic/workflows/disable/action"
    category       = "Administrative"
    status         = "Failed"
    description    = "Logic App disabled - Failure"
    severity       = 3
  }
  "la-monitor-poc-alerts-write-success" = {
    alert_name     = "la-monitor-poc-alerts-write-Success"
    resource_id    = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    operation_name = "Microsoft.Logic/workflows/write"
    category       = "Administrative"
    status         = "Succeeded"
    description    = "Logic App created or updated - Success"
    severity       = 3
  }
  "la-monitor-poc-alerts-write-failure" = {
    alert_name     = "la-monitor-poc-alerts-write-Failure"
    resource_id    = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    operation_name = "Microsoft.Logic/workflows/write"
    category       = "Administrative"
    status         = "Failed"
    description    = "Logic App created or updated - Failure"
    severity       = 3
  }
  "la-monitor-poc-alerts-delete-success" = {
    alert_name     = "la-monitor-poc-alerts-delete-Success"
    resource_id    = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    operation_name = "Microsoft.Logic/workflows/delete"
    category       = "Administrative"
    status         = "Succeeded"
    description    = "Logic App deleted - Success"
    severity       = 3
  }
  "la-monitor-poc-alerts-delete-failure" = {
    alert_name     = "la-monitor-poc-alerts-delete-Failure"
    resource_id    = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    operation_name = "Microsoft.Logic/workflows/delete"
    category       = "Administrative"
    status         = "Failed"
    description    = "Logic App deleted - Failure"
    severity       = 3
  }
}
...
diagnostic_settings = {
  ...
  "deployflow-la-monitor-poc-alerts-workflowruntime" = {
    setting_name    = "deployflow-la-monitor-poc-alerts-workflowruntime"
    resource_id     = "/subscriptions/012ff211-66c6-4b69-a410-88b8ac90045d/resourceGroups/rg-monitor-deployflow/providers/Microsoft.Logic/workflows/la-monitor-poc-alerts"
    log_category    = "WorkflowRuntime"
    metric_category = ""
  }
}
